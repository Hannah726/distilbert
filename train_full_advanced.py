...
def main():
    print("="*50)
    print("Starting Advanced Full Fine-tuning")
    print("="*50)
    ...
    training_args = TrainingArguments(
        ...
        weight_decay=0.01,
        learning_rate=2e-5,
        logging_dir="./logs/full_advanced",
        logging_steps=20,
        eval_strategy="epoch",
        save_strategy="epoch",
    ...
    final_results = {
        "model": "BERT-base Full Fine-tuning",
    ...
    os.makedirs("./results/full_advanced", exist_ok=True)
    save_results(final_results, "./results/full_advanced/metrics.json")
    trainer.save_model("./results/full_advanced/best_model")
    
    print("\n" + "="*50)
    print("Advanced Full Fine-tuning Completed!")
